		...
		mainTemplate.plugin("bootstrap", function(source, chunk, hash) {
			if(chunk.chunks.length > 0) {
				...
				return this.asString([
					...
					`var parentJsonpFunction = ${jsonpFunction};`,
					`var ${jsonpFunction} = function webpackJsonpCallback(chunkIds, moreModules, executeModules) {`,
					this.indent([
...
module.exports = WeexMainTemplatePlugin
